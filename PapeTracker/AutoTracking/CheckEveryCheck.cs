...
namespace PapeTracker
{
    ...
    class CheckEveryCheck
    {
        ...
        public CheckEveryCheck(MemoryReader mem, int offset, int saveAnchor, int sysAnchor, int battleAnchor, World world, Stats stats, Rewards rewards)
        {
            ...
            checksList.Add(new Check(this, Sys3 + 0x14526, Save + 0x23AF, 3));   // DryDryDesert
            checksList.Add(new Check(this, Sys3 + 0x14532, Save + 0x23AF, 4));   // DryDryDesert
            checksList.Add(new Check(this, Sys3 + 0x1453E, Save + 0x23AF, 5));   // DryDryDesert
            checksList.Add(new Check(this, Sys3 + 0x1454A, Save + 0x23AF, 6));   // DryDryDesert
            checksList.Add(new Check(this, Sys3 + 0x14556, Save + 0x23AF, 7));   // DryDryDesert
            checksList.Add(new Check(this, Sys3 + 0x14562, Save + 0x23B0, 0));   // DryDryDesert
            checksList.Add(new Check(this, Sys3 + 0x1456E, Save + 0x23DA, 3));   // DryDryDesert
            ...
            checksList.Add(new Check(this, Sys3 + 0x15492, Save + 0x1D74, 4));   // DryDryDesert Map
            ...
            checksList.Add(new Check(this, Sys3 + 0x1573E, World, "TubbaCastle",          0x20, 0x79));   // AS Vexen
            checksList.Add(new Check(this, Sys3 + 0x1577A, World, "TubbaCastle",          0x20, 0x79));   // Data Vexen
            checksList.Add(new Check(this, Sys3 + 0x1574A, World, "DryDryDesert",                0x21, 0x7B));   // AS Lexaeus
            checksList.Add(new Check(this, Sys3 + 0x15786, World, "DryDryDesert",                0x21, 0x7B));   // Data Lexaeus
            checksList.Add(new Check(this, Sys3 + 0x15756, World, "DryDryOutpost",        0x22, 0x7D));   // AS Zexion
            checksList.Add(new Check(this, Sys3 + 0x15792, World, "DryDryOutpost",        0x22, 0x7D));   // Data Zexion
            checksList.Add(new Check(this, Sys3 + 0x1576E, World, "GustyGulch",           0x26, 0x7F));   // AS Marluxia
            checksList.Add(new Check(this, Sys3 + 0x157AA, World, "GustyGulch",           0x26, 0x7F));   // Data Marluxia
            checksList.Add(new Check(this, Sys3 + 0x15762, World, "JadeJungle",         0x21, 0x81));   // AS Larxene
            checksList.Add(new Check(this, Sys3 + 0x1579E, World, "JadeJungle",         0x21, 0x81));   // Data Larxene
            checksList.Add(new Check(this, Sys3 + 0x157DA, World, "MtLavalava",                  0x14, 0x6A));   // Data Xemnas
            checksList.Add(new Check(this, Sys3 + 0x157E6, World, "DryDryRuins",          0x0A, 0x6C));   // Data Xigbar
            checksList.Add(new Check(this, Sys3 + 0x157C2, World, "MtRugged",           0x0F, 0x63));   // Data Xaldin
            checksList.Add(new Check(this, Sys3 + 0x157F2, World, "BooMansion",             0x0F, 0x6E));   // Data Saix
            checksList.Add(new Check(this, Sys3 + 0x157CE, World, "KoopaRegion",           0x14, 0xD4));   // Data Axel
            checksList.Add(new Check(this, Sys3 + 0x157B6, World, "KoopaFortress",          0x04, 0x8D));   // Data Demyx
            checksList.Add(new Check(this, Sys3 + 0x157FE, World, "ShyGuyToybox",              0x0E, 0x70));   // Data Luxord
            checksList.Add(new Check(this, Sys3 + 0x1580A, World, "ToadTownTunnels",  0x15, 0x72));   // Data Roxas
